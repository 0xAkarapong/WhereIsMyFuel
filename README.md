# Where's My Fuel ⛽
## ทำทั้งหมดด้วย Perplexity Computer, Opencode, Gemini CLI ด้วยความสงสัยว่าทำไมหน่วยงานท้องถิ่นถึงทำแต่จังหวัดตัวเอง ทั้งๆ ที่การเดินทางข้ามจังหวัดเป็นเรื่องทั่วไป รายละเอียดที่เหลือ Perplexity เขียนให้ เดี๋ยวผมมาแก้ครับ ขออภัยสำหรับการเป็น Engineer ที่ไม่ดี
